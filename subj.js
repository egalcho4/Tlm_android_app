 ...
 var numb=document.getElementById('snmb');
   ...
   var min1=parseInt(min);
    ...
    //for(var i=0;i<2;i++){
    	...
    	var newrowc=tabl.insertRow()
    	newrowc.innerHTML="general_students_report";
var newrow=tabl.insertRow()
    	var pr=(num.length/marko.length)*100;
     var f=(fm.length/nfm.length)*100;

    	newrow.insertCell().innerHTML="b/n "+min+"&"+max;
    	newrow.insertCell().innerHTML=" "+num.length;
    	newrow.insertCell().innerHTML=" "+Math.round(pr)+"%";
    	var newrowa=tabl.insertRow()
    	newrowa.innerHTML="Female_students_report ";
var newrowb=tabl.insertRow()
    	newrowb.insertCell().innerHTML="b/n "+min+"&"+max;
newrowb.insertCell().innerHTML=" "+fm.length;
newrowb.insertCell().innerHTML=" "+Math.round(f)+"%";


    //}
     /*var bw=document.createElement("div");
     bw.innerHTML=min+"&"+max+"<br><hr style='height:5px;width:100%;border:2px solid black ;background-color:black'><span>female</span><br><br><hr style='height:5px;width:100%;border:2px solid black ;background-color:black'>"+min+"&"+max;
     bwn.appendChild(bw)
     var per=document.createElement("div");
     var pr=(num.length/marko.length)*100;
     var f=(fm.length/nfm.length)*100;
     per.innerHTML=parseInt(pr)+"%"+"<br><br><br><br><hr style='height:5px;width:100%;border:2px solid black; background-color:black'>"+parseInt(f)+"%";
     perc.appendChild(per)
     
var st=document.createElement("div");
     st.innerHTML=num.length+"<br><br><br><br><hr style='height:5px;width:100%;border:2px solid black; background-color:black'>"+fm.length;
     numb.appendChild(st)
...
dat.forEach(row => {
	if (selectedRow == null) {
		...
		newRow.insertCell().innerHTML = `<a onClick="opend(this)" style="font-size:70px" class="btn text-primary">&#10149;<i class="fas fa-times"></i></a>` // newRow.insertCell().innerHTML = `<a onClick="addmark(this)"><button ><a href="mark.html">add mark</a></button><i class="fas fa-times"></i></a>`
		...
		newRow.insertCell().innerHTML = `<a onClick="Details(this)"style="font-size:70px" class="btn text-warning ">&#9865;<i class="fas fa-times"></i></a>` // newRow.insertCell().innerHTML = `<a onClick="addmark(this)"><button ><a href="mark.html">add mark</a></button><i class="fas fa-times"></i></a>`
...
function move(test, color, p) {
	...
	function frame() {
		if (width >= p) {
			...
			test.setAttribute("style", "border:4px solid black;  border-radius:10px;width:200px;height:400px;font-size:50px");
...
function move1(test, color, p) {
	...
	function frame() {
		if (width >= p) {
			...
			elem.style.height = width + '%';
			elem.innerHTML = width+"%";
			test.setAttribute("style", "margin-bottom:0px;border:4px solid black;  border-radius:10px;width:200px;height:400px;font-size:50px");
