...
newRow.insertCell().textContent = proforme.evtext.value;
	...
	newRow.insertCell().innerHTML = '<button onclick="removeme(this)" style="color:red">X</button>';
...
newRow.insertCell().textContent = proforma.how.value;
	...
	newRow.insertCell().innerHTML = '<button onclick="programa(this)" style="color:red">X</button>';
...
hom1.setAttribute("style","transform:scale(1);z-index:1;transition:1s;float:left;margin-left:150px;font-size:70px;border-top:30px solid white;border-left:25px solid white;border-right:25px solid white;border-buttom:5px solid white;border-radius:20px 10px 50% 50%")
pl.setAttribute("style","float:left;margin-left:20%;font-size:70px")
pp.setAttribute("style","float:right;margin-right:30px;font-size:70px")
...
hom2.setAttribute("style","float:left;margin-left:0px;font-size:70px")

frog.setAttribute("style","color:red;font-size:70px;margin-left:40%");
...
tm.style.display="block";
home2.style.display ="none";
prog1.setAttribute("style","color:red;font-size:70px;margin-left:40%");
hom2.setAttribute("style","float:left;margin-left:0px;font-size:70px")

frog.setAttribute("style","display:none");
 pl.setAttribute("style","transform:scale(1);z-index:1;transition:1s;float:left;margin-left:20%;font-size:70px;border-top:30px solid white;border-left:25px solid white;border-right:25px solid white;border-buttom:5px solid white;border-radius:20px 10px 50% 50%")
hom1.setAttribute("style","float:left;margin-left:150px;font-size:70px")
pp.setAttribute("style","float:right;margin-right:30px;font-size:70px")

hash.setAttribute("id","hash1");
})
pp.addEventListener('click',()=>{
 pp.setAttribute("style","transform:scale(1);z-index:1;transition:1s;float:right;margin-left:30px;font-size:70px;border-top:30px solid white;border-left:25px solid white;border-right:25px solid white;border-buttom:5px solid white;border-radius:20px 10px 50% 50%")
hom1.setAttribute("style","float:left;margin-left:150px;font-size:70px")
pl.setAttribute("style","float:left;margin-left:20%;font-size:70px")
hom2.setAttribute("style","float:left;margin-left:0px;font-size:70px")
...
homr.style.maxHeight=window.innerHeight-350+"px";
 ...
 hom2.setAttribute("style","transform:scale(1);z-index:1;transition:1s;float:left;margin-left:0px;font-size:70px;border-top:30px solid white;border-left:25px solid white;border-right:25px solid white;border-buttom:5px solid white;border-radius:20px 10px 50% 50%")
hom1.setAttribute("style","float:left;margin-left:150px;font-size:70px")
pl.setAttribute("style","float:left;margin-left:20%;font-size:70px")
center.style.display="none";
former.style.display ="none";
